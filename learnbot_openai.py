...
def transcribe_audio(resp_media: str) -> str:
    ...
    with open('learnbot/temp.oga', 'wb') as f:
        ...
        for i in response["result"]:
            ...
            if 'callback_query' in i:
                ...
                if user_id in data or user_id in admin:
                    ...
                    elif not user_id in admin: # Options: voice_name or integer value (user)
